...
tickers_data = yf.download(tickers, start=START, end=END, interval="1d")['Adj Close']
benchmark_data = yf.download(benchmark, start=START, end=END, interval="1d")['Adj Close']
